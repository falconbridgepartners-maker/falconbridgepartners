...
import { featuredStudy, research } from '@/content/site';
...
export default function StudiesPage() {
  return (
    <>
      ...
      <Section>
        <Link href={`/research/studies/${featuredStudy.slug}`} className="group tile p-8 md:p-10 block hover:border-brand-gold/60 transition-colors">
          ...
          <p className="text-white/70 mb-6">{featuredStudy.subtitle}</p>
